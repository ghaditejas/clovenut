...
app.post('/api/createFrame', cpUpload, function (req, res, next) {
	...
	connection.query(
		"INSERT INTO Frame (Frame_Code, Frame_Name, Frame_Description, Frame_External_Link, Frame_Image_1, Frame_Image_2, Frame_Image_3,Frame_Image_4,Frame_Category) VALUES ('"+code+"', '"+name+"', '"+description+"','"+url+"','"+image1[0].filename+"','"+image2[0].filename+"','"+image3[0].filename+"','"+image4[0].filename+"','"+category+"')", 
