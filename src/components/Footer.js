  ...
  render() {
    return (
      ...
      >
        ...
        <div className="page-width">
          <div className="grid grid--no-gutters small--text-center grid--footer-float-right">
            <div className="grid__item small--hide one-half site-footer-item-center-vertically mm-payment-icon">
            </div>
            <div className="grid__item one-half small--one-whole site-footer-item-tall mm-social-icons">
            ...
            <div className="grid__item medium-up--hide one-half small--one-whole">
              <div className="grid__item site-footer__payment-icons">
            ...
            <div className="grid__item small--one-whole  site-footer-item-align-right mm-copyright-section">
              ...
              <small className="site-footer__copyright-content site-footer__copyright-content--powered-by">
                <a
                  target="_blank"
